...
class Babiesform(models.Model):
    c_stay=models.ForeignKey(Categorystay ,on_delete=models.CASCADE,default=1,null=True,blank=True)
...
#here we are getting change.(money to be given to theparent)    
    ...
    def get_change(self):
      ...
      if total is None or self.amount_received is None:
        return None
      else:
        return int(total - self.amount_received)
